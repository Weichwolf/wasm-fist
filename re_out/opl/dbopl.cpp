...
/* DBOPL::Handler methods removed (DOSBox mixer glue).  The port drives Chip::Setup / WriteReg /
 * GenerateBlock2/3 directly + calls InitTables() once, via fist_opl_dbopl.cpp. */
