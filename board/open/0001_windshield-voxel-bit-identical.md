...
## Merged-in work log (was a headerless duplicate at board/active/0001_windshield-voxel-bit-identical.md)

The board convention is one file per item and the path IS the state; this log had been appended
to a second, header-less file under board/active/ carrying the same number, so item 0001 existed in
