...
decompile-drivers: ## Ghidra headless on each driver overlay image -> re_out/fist_{mga,snd}_decomp.c (engine seeders gated off)
	...
	FIST_IMAGE=$(ROOT)/re_out/fist_snd_image.bin FIST_PROJ_NAME=fist_snd FIST_ENTRY=0x0 FIST_ENGINE_SEEDERS=0 FIST_FRESH=1 \
	  FIST_DRIVER_SEED_OFFS="0x2,0x5,0x6,0x78,0xc1,0xfd,0x14e,0x19a,0x1e7,0x1ec,0x1fd,0x245,0x24b,0x252,0x2e9,0x333,0x3dd,0x414,0x419,0x426,0x56b,0x643,0x685,0x77f,0x833,0x1e5e,0x872,0xa14,0xf21,0xf48,0xf54,0xf99,0x104f,0x1082,0x10a5,0x10a6,0x10e3" \
