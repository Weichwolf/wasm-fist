...
# render), 0x13487 (the 22f7 phase dispatch) -- and dumps the DGROUP window (the oracle's DGROUP is at
...
exec env OC_WALL="${OC_WALL:-45}" \
  ...
  FIST_REGTRACE_LIN=11447,11454,24288,1d275,24ab0,158e4,1346d,13487 \
