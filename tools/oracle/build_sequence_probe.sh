...
elif [ "$render_hash" != 421fadc54312b5a5fdf999a25329a69542b0c9b1a491805e02a9f76e5cfd6bff ] ||
     [ "$mixer_hash" != d0e30cf048ac6cd8206ba580e838e6d0c8c535d990c63e4135cd2baace58a52f ]; then
  echo 'DOSBox source differs from both the expected base and the probe patch' >&2
  exit 1
fi
make -C "$TREE" -j4
printf 'DOSBox probe: %s\n' "$TREE/src/dosbox"
